...
source.include_patterns = assets/*.png, assets/*.json, assets/*.jpeg, assets/*.webp, assets/*.gif
...
presplash.filename = %(source.dir)s/assets/NexusLogo.png
